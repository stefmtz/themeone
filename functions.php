...
function themeone_setup() {
	 ...
	 * to change 'themeone' to the name of your theme in all the template files.
	 */
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'themeone' ),
	) );
 ...
 */
function themeone_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'themeone_content_width', 640 );
}
add_action( 'after_setup_theme', 'themeone_content_width', 0 );
...
function themeone_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'themeone' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'themeone' ),
...
function themeone_scripts() {
	...
	wp_enqueue_script( 'themeone-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'themeone-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
